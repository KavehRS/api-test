var active_session, ip, user_id, timeout = 1, url = "http://192.168.143.18:8876/api/", system_id = "Developer",
    auth_token = "my_auth_token", ttl = 30, counter = ttl,
    ACTIVITY = {Play: 1, Pause: 2, FDStart: 3, FDEnd: 4, BDStart: 5, BDEnd: 6, ContentView: 7},
...
String.prototype.format || (String.prototype.format = function () {
    ...
    check: function () {
        ...
        if (ip) {
            ...
            if (user_id != e || !t) {
                ...
                return o.open("POST", "{0}session/".format(url), !0), o.setRequestHeader("Content-Type", "application/json"), o.onreadystatechange = function () {
    ...
    log: function (e, t, n, o, i, r) {
        ...
        return c.open("POST", "{0}event/".format(url), !0), c.setRequestHeader("Content-Type", "application/json"), c.onreadystatechange = function () {
